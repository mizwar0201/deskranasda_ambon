    ...
    <section class="ftco-about d-md-flex">
    	...
    	<div class="one-half ftco-animate">
	        ...
	        <div class="heading-section ftco-animate ">
	        	<span class="subheading">Sambutan</span>
	          <h2 class="mb-4">Ketua Deskranasda</h2>
	        </div>
	        <div>
	  				<p>Setelah pelantikan ini, tugas utama yang harus dilakukan oleh ketua dan pengurus adalah melaksanakan rapat kerja daerah sebagai amanat konstitusi Dekranas tahun 2020. Tugas ini menjadi prioritas dalam menjalankan amanah sebagai ketua dan pengurus Dekranasda kota Ambon. Saya berharap program dan kegiatan yang nanti disusun harus memberikan sentuhan dari penjabaran visi-misi Pemerintah Kota (Pemkot) Ambon, sehingga pola kemitraan dapat terus terjalin dalam upaya meningkatkan kesejateraan hidup para pelaku industri kerajinan dengan memanfaatkan potensi dan  kearifan lokal di desa/kelurahan dan  kecamatan sebagai modal sosial ekonomi.</p>
	  			</div>
  			</div>
    	</div>
    </section>
    ...
    <section class="ftco-section">
    	<div class="container">
          ...
          <div class="col-md-7 heading-section ftco-animate text-center">
            ...
            <h2 class="mb-4">PRODUK DESKRANASDA AMBON</h2>
            <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
            <p><a href="#" class="btn btn-primary btn-outline-primary">Lihat Semua >></a></p>
          </div>
        </div>
        <div class="row">
        	<div class="col-md-3">
